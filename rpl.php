        ...
        <div class="row">
            <div class="container">
                ...
                <table class="table mb-5">
                    ...
                    <?php
                        include 'koneksi.php';
                        $daftar_rpp = mysqli_query($koneksi,"SELECT dbrpp.id, dbrpp.nama, dbrpp.file, dbjurusan.nama as jurusan, dbkelas.nama as kelas FROM dbrpp INNER JOIN dbjurusan ON dbrpp.idjurusan=dbjurusan.id INNER JOIN dbkelas ON dbrpp.idkelas=dbkelas.id WHERE dbjurusan.singkatan='RPL'");
